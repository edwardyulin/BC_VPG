...
class MLPContinuousActor:
    ...
    #TODO: change loss_func and optimizer
    model: Sequential
    ...
    def build(
        ...
        output_layer = Dense(action_size, activation="sigmoid")
        ...
        self.loss_func = MeanSquaredError(from_logits=True)
    ...
    def fit(
        ...
        with tf.GradientTape() as tape:
            pred_actions = self.model(observations, training=True)
            actor_loss = self.loss_func(pred_actions, actions)
        """
